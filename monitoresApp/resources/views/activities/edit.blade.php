...
<div class="container py-4">
    ...
    <div class="d-flex flex-column justify-content-center gap-3 mb-4 text-center">
        <h5>Elige un método de edición</h5>
        <div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Leer el valor de "old" para saber qué modo se estaba usando antes (en caso de errores)
        const oldMode = @json(old('mode', 'structured'));
        if (oldMode === 'free') {
            activateFree();
        } else {
            activateStructured();
